...
public class FreshcardController {
	...
	@RequestMapping(value="admin/findCard/{id}",method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public String findCardById(@PathVariable("id") int id) {
		return freshcard.findCardById(id);
	}
